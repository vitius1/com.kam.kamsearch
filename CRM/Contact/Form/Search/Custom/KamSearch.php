...
class CRM_Contact_Form_Search_Custom_KamSearch extends CRM_Contact_Form_Search_Custom_Base implements CRM_Contact_Form_Search_Interface {
  ...
  public function buildForm(&$form) {
    ...
    $form->addElement('text', 'limit', ts('Maximální počet výsledků'), ['value' => '1000']);
    $form->addElement('hidden', 'id');

    $this->setTitle('Vyhledávání');

    $form->assign('elements', array('name', 'type', 'group', 'country', 'kraj', 'town', 'address_name', 'kam_region', 'denomination', 'program', 'relationship', 'event', 'limit', 'id'));
  }
